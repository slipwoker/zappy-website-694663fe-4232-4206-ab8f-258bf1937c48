    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Honeymoon-Vip משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '694663fe-4232-4206-ab8f-258bf1937c48',
                    name: data.name || '',
                    email: data.email || '',
